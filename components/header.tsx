...
export default function Header() {
  ...
  return (
    <header className="relative z-999">
      <motion.div
        className="fixed left-1/2 top-0 h-18 w-full  rounded-none border border-white/40 bg-white/80 shadow-lg shadow-black/3 backdrop-blur-[0.5rem] dark:border-black/40 dark:bg-gray-950/75 sm:top-6 sm:h-13 sm:w-xl sm:rounded-full"
